...
if count != 1 and 'function isVerifier(file)' not in text:
...
elif "relative === 'scripts/verify-standalone.mjs'" not in text:
    raise SystemExit('Standalone verify loop not found')
